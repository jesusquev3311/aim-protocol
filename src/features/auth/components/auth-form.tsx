...
export function AuthForm({ mode }: AuthFormProps) {
  ...
  return (
    <form className="space-y-4" onSubmit={handleSubmit(onSubmit)} noValidate>
      ...
      {!isRegister && <div className="text-right"><Link className="text-sm font-medium text-primary hover:underline" to="/forgot-password">¿Has olvidado tu contraseña?</Link></div>}
