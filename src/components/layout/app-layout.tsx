      ...
      <header className="border-b bg-card/70 backdrop-blur">
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4">
          ...
          <div className="flex items-center gap-3">
            <nav className="hidden items-center gap-1 md:flex" aria-label="Primary navigation"><Link to="/dashboard" className="inline-flex h-9 items-center gap-2 rounded-md px-3 text-sm hover:bg-muted"><LayoutDashboard className="h-4 w-4" />Dashboard</Link><Link to="/challenges" className="inline-flex h-9 items-center gap-2 rounded-md px-3 text-sm hover:bg-muted"><Flag className="h-4 w-4" />Challenges</Link><Link to="/routine" className="inline-flex h-9 items-center gap-2 rounded-md px-3 text-sm hover:bg-muted"><Dumbbell className="h-4 w-4" />Routine</Link><Link to="/statistics" className="inline-flex h-9 items-center gap-2 rounded-md px-3 text-sm hover:bg-muted"><BarChart3 className="h-4 w-4" />Analytics</Link></nav>
